...
{name:'Yanartaş',url:'../trips/antalya-2026/places/yanartas/',c:[30.4655,36.4319],type:'Myth & fire',img:'images/yanartas.jpg',note:'Methane-rich flames burning from bare rock since antiquity — go at dusk.'},
...
{name:'Adrasan',url:'../trips/antalya-2026/places/olympos/',c:[30.4802,36.3068],type:'Trailhead',img:'images/olympos.jpg',note:'Quiet bay and the start of the Musa Dağı crossing to Olympos.'},
{name:'Göynük Canyon',url:'../trips/antalya-2026/places/goynuk/',c:[30.5455,36.6821],type:'Canyon',img:'images/goynuk.jpg',note:'Clear-water gorge; the lower canyon is family-sized, the uplands are serious hiking.'},
{name:'Termessos',url:'../trips/antalya-2026/places/termessos/',c:[30.4654,36.9821],type:'Mountain ruins',img:'images/termessos.jpg',note:'A mountain city Alexander failed to force; its ruins remain largely unexcavated.'},
